...
func Float32TInt(f float32, scala int) int {
	return (int(f*float32(pow(scala+1))) + 5) / 10
}
func Float64TInt64(f float64, scala int) int64 {
	return (int64(f*float64(pow(scala+1))) + 5) / 10
}
